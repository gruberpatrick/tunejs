...
module.exports = {
	...
	loadID3V1: function(sPath, oInfo, oFile){
		...
		oSongV1.lAdded = Math.round(Date.now() / 1000);
		oSongV1.lBitrate = 0;
		oSongV1.lLength = 0;
		oSongV1.lLengthEstimated = 0;
		oSongV1.lLastPlay = 0;
		oSongV1.lLastSkip = 0
		oSongV1.lPlayCount = 0;
		oSongV1.lSkipCount = 0
	...
	loadID3V2: function(sPath, oInfo, oFile){
		...
		oSongV2.lBitrate = 0;
		oSongV2.lLength = 0;
		oSongV2.lLengthEstimated = 0;
		oSongV2.lLastPlay = 0;
		oSongV2.lLastSkip = 0
		oSongV2.lPlayCount = 0;
		oSongV2.lSkipCount = 0
	...
	parseBuffer: function(sInput){
		...
		return sInput.toString().replace(/\u0000/, '');;
